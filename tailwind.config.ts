  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'zappy-dark': '#1E1F26',       // Rich Gunmetal
        'zappy-light': '#F5F7FA',      // Mist Gray
        'zappy-text': '#EAEAEA',       // Off White
        background: '#000',
      ...
      keyframes: {
        ...
        'pulse-glow': {
          '0%, 100%': { boxShadow: '0 0 20px 5px rgba(90, 49, 244, 0.2)' },
          '50%': { boxShadow: '0 0 30px 10px rgba(90, 49, 244, 0.4)' },
        },
      },
      animation: {
